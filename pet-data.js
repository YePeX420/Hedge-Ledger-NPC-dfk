...
// Simplified format since skill name is shown separately
const GATHERING_SKILL_DESCRIPTIONS = {
  'Fortune Seeker': '{bonus}% gathering effect',
  'Clutch Collector': '{bonus}% gathering effect',
  'Bountiful Catch': '{bonus}% gathering effect',
  'Skilled Angler': '{bonus}% gathering effect',
  'Keen Eye': '{bonus}% gathering effect',
  'Power Surge': 'Increase Power Token or JEWEL rewards from gardening by {bonus}%',
  'Astute Angler': '{bonus}% gathering effect',
  'Efficient Scavenger': '{bonus}% gathering effect',
  'Runic Discoveries': '{bonus}% gathering effect',
  'Bonus Bounty': '{bonus}% gathering effect',
  "Gaia's Chosen": "{bonus}% gathering effect",
  'Efficient Angler': '{bonus}% gathering effect',
  'Bountiful Haul': '{bonus}% gathering effect',
  'Innate Angler': '{bonus}% gathering effect',
  'Astute Scavenger': '{bonus}% gathering effect',
  'Skilled Scavenger': '{bonus}% gathering effect',
  'Bountiful Harvest': '{bonus}% gathering effect',
  'Efficient Greenskeeper': '{bonus}% gathering effect',
  'Skilled Greenskeeper': '{bonus}% gathering effect',
  'Astute Greenskeeper': '{bonus}% gathering effect',
  'Innate Scavenger': '{bonus}% gathering effect',
  'Innate Greenskeeper': '{bonus}% gathering effect',
  'Second Chance': '{bonus}% gathering effect',
