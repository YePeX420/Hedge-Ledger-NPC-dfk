...
*   **Hero Genetics System**: Complete genetics decoding layer with two specialized decoders using official DeFi Kingdoms Kai (base-32) encoding:
    ...
    *   **Visual Breeding Aids**: Automatic hairstyle summoning tree chart sharing in DMs. When users ask about hairstyle mutations, breeding, or visual genetics, Hedge automatically attaches official DFK summoning tree charts (`knowledge/female-hairstyle-chart.png` and `knowledge/male-hairstyle-chart.png`) to help visualize mutation paths and breeding strategies.
