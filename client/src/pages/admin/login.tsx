    ...
    >
      <Card className="w-full max-w-md">
        <CardHeader className="text-center space-y-4">
          <div className="mx-auto w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center">
            <span className="text-2xl font-bold text-white">HL</span>
          </div>
          <div>
            <CardTitle className="text-2xl">Hedge Ledger Admin</CardTitle>
        ...
        <CardContent className="space-y-4">
          <Button 
            onClick={login}
            className="w-full h-12 text-base gap-3 bg-[#5865F2] hover:bg-[#4752C4]"
          ...
          <p className="text-center text-sm text-muted-foreground">
            Only authorized Discord accounts can access the admin area.
          </p>
        </CardContent>
      </Card>
    </div>
